...
const Counter = () => {
  ...
  return (
    ...
    <div className='flex justify-center items-center'>
      <div
      className="mt-6 w-80 p-3  border border-gray-200 rounded-lg shadow bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
      >
        {/* カウント対象 */}
        {music != '' &&
        <div className={`flex justify-center items-center space-x-4 ${music !== '' ? 'm-7' : ''}`}>
